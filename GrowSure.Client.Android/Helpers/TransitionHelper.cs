...
namespace GrowSure.Client.Android.Helpers
{
	public static class TransitionHelper
	{
		public static Pair[] CreateSafeTransitionParticipants (Activity activity, bool includeStatusBar, params Pair[] otherParticipants)
		{
			...
			View statusBar = null;
			if (includeStatusBar)
				statusBar = decor.FindViewById (global::Android.Resource.Id.StatusBarBackground);
			var navBar = decor.FindViewById (global::Android.Resource.Id.NavigationBarBackground);

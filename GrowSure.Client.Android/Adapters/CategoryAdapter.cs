...
namespace GrowSure.Client.Android.Adapters
{
	public class CategoryAdapter : BaseAdapter
	{
		...
		{
			return (Java.Lang.Object) categories [position];
		}
		...
		{
			categories = GrowSureDatabaseHelper.GetCategories (activity, true);
		}
		...
		Drawable LoadTintedDoneDrawable ()
		{
			...
			TintDrawable (global::Android.Resource.Color.White, ref done);
			return done;
		}
